...
surrogateOrientation = ProgrammableFilter(registrationName='SurrogateOrientation', Input=extractTimeSteps1)
surrogateOrientation.Script = """
...
# create a new 'Slice'
slice1 = Slice(registrationName='Slice1', Input=surrogateOrientation)
